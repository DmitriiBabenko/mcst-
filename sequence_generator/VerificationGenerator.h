...
public:
    static std::string generateVerificationCode(const std::vector<std::shared_ptr<Node>> & sorted_nodes, const std::unordered_map<std::shared_ptr<Node>, std::size_t> & rho, unsigned num_registers, unsigned seed);
...
private:
    ...
    static std::string generateMainFunction(const std::vector<std::shared_ptr<Node>> & sorted_nodes, const std::unordered_map<std::shared_ptr<Node>, std::size_t> & rho, unsigned num_registers, unsigned seed);
